...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('range_max', default_value='10', description='Maximum range of the sonar in meters.'),
        DeclareLaunchArgument('angle_sector', default_value='360', description='Angle sector for the sonar scan in degrees.'),
        DeclareLaunchArgument('angle_step', default_value='5', description='Step size for the angle in degrees.'),
        ...
        Node(
            package='ping360_sonar',
            executable='sensor_color_rgb.py',
        )
    ])
